...
module.exports = {
  ...
  pageMetaInfo: {
    about: {
      description: 'Nx Digital aims to become a leading Digital Transformation and Strategy Company globally with a solid Technology backbone to fuel business growth.',
    },
    websiteDevelopment: {
      description: 'Nx Digital develops and designs SEO friendly and mobile responsive websites which are rich in UI / UX and load very quickly.',
    },
    digitalMarketing: {
      description: 'Nx Digital propels business growth and profitability by providing Digital Marketing Services and Technology services.',
    },
    appDevelopment: {
      description: 'Nx Digital can help you design and develop Mobile Apps on both iOS as well as Android devices. Our Apps are rich in UI / UX, easy to navigate, load very fast and occupy less storage space.',
    },
    outsourcedCMO: {
