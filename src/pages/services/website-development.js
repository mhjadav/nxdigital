        ...
        <section id="tw-features-contact" className="tw-features-contact">
            <div className="container">
                ...
                <div className="col-md-6">
                    ...
                    <p>Your website represents your brand and your business. So, the user experience is critical.</p>
                    <p>While developing your website, you also want to make it SEO friendly. This let's people find you on Google and other search engines. </p>
                    <p>Apart from this, your website must be secure, should load fast and be mobile responsive. </p>
                    ...
                    <p>Book a complimentary session to get started with your requirements or if you already have a website, request a call back to get a complimentary website audit done.</p>
                </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 align-self-center">
                            <div className="tw-web-analytics-content">
                                ...
                                <p>
                                    UI/UX Designing plays a vital role here. Our team uses sophisticated tools like Illustrator, Zeplin and several others to deliver a high quality experience for the end users. We also have a team of graphic designers to develop images and other graphic elements required to propel your brand value. 
