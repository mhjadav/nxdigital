    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-md-4 text-center">
          <div className="tw-service-box">
            <div className="service-content">
              <h3>Highly Skilled and Professional Team</h3>
              <p>
      ...
      <div className="row">
        <div className="col-md-4 text-center">
          <div className="tw-service-box">
            <div className="service-content">
              <h3>Effective Use of Technology</h3>
              <p>
        ...
        <div className="col-md-4 text-center">
          <div className="tw-service-box">
            <div className="service-content">
              <h3>Strong Ethics and Empathy</h3>
              <p>
